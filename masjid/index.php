    ...
    <main>
        <header>
            <div class="header-text">
                ...
                <a href="input.php"><button class="donasi-button">Beri Bantuan Shodaqoh</button></a>
            </div>
    ...
    <!-- <div class="bg-body-light p-5 rounded-top border border-light shadow"> -->
                <div class="roww">
                    <div class="col-sm-4 py-5 mx-auto">
                        ...
                        <h1 class="display-5 fw-bold" style="margin-right:100px;"><?php
                    ...
                    <div class="col-sm-4 py-5 mx-auto">
                        ...
                        <h1 class="display-5 fw-bold" style="margin-right:90px;"> <?php
...
<script>
    ...
    var marqueeElement = document.getElementById("donators-marquee");

    donators.forEach(function (donator) {
        var donatorName = document.createElement("span");
        donatorName.className = "donator-name";
        donatorName.textContent = donator.nama + " - ";
        marqueeElement.appendChild(donatorName);

        var donatorCategory = document.createElement("span");
        donatorCategory.className = "donator-kategori";
        donatorCategory.textContent = donator.kategori + ": ";
        marqueeElement.appendChild(donatorCategory);

        var donatorNominal = document.createElement("span");
        donatorNominal.className = "donator-nominal-barang";
        donatorNominal.textContent = typeof donator.nominal === "number" ? "Rp." + donator.nominal.toLocaleString("id-ID") : donator.nominal;
        marqueeElement.appendChild(donatorNominal);
    });
